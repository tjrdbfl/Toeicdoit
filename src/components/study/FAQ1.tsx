...
const FAQ1 = () => {
    return (<>
        <div className="flex flex-col">
            <p className="text-black font-normal w-full text-start mt-5">
                토익두잇은 레벨테스트의 결과를 기반으로 레벨 1부터 레벨 9까지 100점 단위로 나누어 사용자의 학습 목표 설정과 맞춤형 학습 콘텐츠 제공에 도움을 줄 수 있습니다.
            </p><br />
            <div className="flex flex-row gap-x-2 items-center">
                <LinkIcon size={20} />
                <p className="text-black font-semibold text-lg w-full text-start">
                    레벨
                </p>
            </div>

            <p className="text-black font-normal text-lg w-full text-start">
                레벨 1: 0 ~ 199점
            </p>
            <p className="text-black font-normal text-lg w-full text-start">
                레벨 2: 200 ~ 299점
            ...
            <div className="flex flex-row gap-x-2 items-center">
                ...
                <Link
                    href={`${PG.LEVEL_TEST}`}
                    className="underline hover:text-blue-700 text-blue-500 w-[300px] ml-5 flex justify-start"
                >
                    레벨 테스트 하러가기
                </Link>
            </div>
