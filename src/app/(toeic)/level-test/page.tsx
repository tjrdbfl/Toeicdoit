            ...
            <div className="w-full flex justify-center items-center">
                <div className="bg-blue-50 shadow-lg rounded-xl w-[700px] h-auto p-5 flex flex-col justify-center items-center">
                    <div className="flex flex-row gap-x-2 w-full justify-center">
                        ...
                        <p className="text-black text-lg font-bold text-center">단, 20분 만에 </p>
                        <p className="border-b-red-500 border-b-4 text-blue-500 text-lg font-bold text-center bg-yellow-100">지금 나의 TOEIC 실력을 파악해보세요!</p>
                    ...
                    <div className="flex">
                        <div className="order-2 z-10 bg-white shadow-md w-[350px] h-[400px] p-10 flex flex-col justify-center items-center">
                            ...
                            <p className=" text-zinc-600 font-bold mt-5 text-center text-lg">무료 레벨테스트</p>
                            <p className="text-zinc-700 text-center text-md mt-5 font-medium text-pretty">지금 바로 내 실력 확인하고 맞춤 학습 전략 세우기!</p>
                            <div className="bg-zinc-200 w-[260px] lg:w-[420px] 2xl:w-[480px] h-[10px] rounded-full" />
                            <p className="text-zinc-700 text-center text-md mt-5 font-medium border-b-zinc-400">레벨 테스트를 통해</p>
                            <div className="bg-zinc-200 w-[120px] lg:w-[150px] 2xl:w-[180px] h-[10px] rounded-full" />
                            <p className="text-zinc-700 text-center text-md mt-5 font-medium border-b-zinc-400">자신의 약점을 파악하고 강화해보세요! </p>
