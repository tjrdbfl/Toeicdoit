...
const UserPaymentContainer = ({
  ...
  return (
    <>
      <ScrollArea
        className="overflow-y-auto flex flex-col rounded-lg h-[400px] mt-2 mb-4 scroll-area p-2 shadow-md border-2 border-slate-100 flex justify-center items-center">
